...
```cmd
set MYSQL_PASSWORD=zc123456 && python D:\bao\juejin\juejin_pins.py
```
...
```cmd
set MYSQL_PASSWORD=zc123456 && python D:\bao\juejin\server\app.py
```
...
```cmd
python D:\bao\juejin\juejin_checkin.py
```
...
```powershell
schtasks /create /tn "JuejinCheckin" /tr "python D:\bao\juejin\juejin_checkin.py" /sc daily /st 09:00
```
